  ...
  return (
    ...
    <Grid
      ...
      <Grid.Col span={12}>
          ...
          <Title order={1}>Never Miss a Review</Title> 
          <Title order={2}fw={200}>Sign up for our Newsletter</Title> 
          <Flex gap="md">
          <TextInput w={400} size="md" radius="lg" placeholder="you@example.com" mb="xl" /> 
